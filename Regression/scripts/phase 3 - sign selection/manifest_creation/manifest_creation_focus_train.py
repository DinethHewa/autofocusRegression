#!/usr/bin/env python3
"""
Phase-3 focusTrain manifest creator (wrapper around Phase-1 script).
...
def main() -> None:
    p1 = load_phase1_module("manifest_creation_focus_train.py")

    ap = argparse.ArgumentParser(description="Phase-3 focusTrain manifest creator (wrapper).")
