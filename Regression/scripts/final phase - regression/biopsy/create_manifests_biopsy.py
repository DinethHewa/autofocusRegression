...
GROUP_DATASETS = ["focus_train", "focus_test"]
PHASE3_FLAG_BY_DATASET = {
    "focus_train": "--focus-train",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Create/reuse manifests and tables for biopsy datasets: focus_train, focus_test."
    )
    parser.add_argument(
        "--force",
        action="store_true",
    ...
    parser.add_argument(
        ...
        help="Subset of biopsy datasets to process (default: all).",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
